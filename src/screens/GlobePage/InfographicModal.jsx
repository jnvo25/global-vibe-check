                ...
                >
                    ...
                    <Card>
                        ...
                        <Card.Title style={{
                            ...
                            color: props.vacStats !== undefined ? colorByRisk(props.vacStats.Infection_Risk) : "gray"}}>
                                {props.name}, {props.country} | Vibes are <strong>{props.vacStats !== undefined ? getVibes(props.vacStats.Infection_Risk) : "..not found"}</strong>
                        </Card.Title>
